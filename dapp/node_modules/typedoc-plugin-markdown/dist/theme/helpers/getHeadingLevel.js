...
function getHeadingLevel(baseLevel) {
    return theme_service_1.ThemeService.getMarkdownEngine() === markdown_engine_enum_1.MarkdownEngine.GITBOOK ? baseLevel.substring(0, baseLevel.length - 1) : baseLevel;
}
